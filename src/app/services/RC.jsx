    ...
    <section className="py-10">
      <div className="container">
        <div className="text-left md:text-center mb-5">
          <h2 className="mb-3">Frequently Asked Questions (FAQ)<br />— Prime Ready Mix</h2>
      ...
      <div className="px-3 max-w-3xl mx-auto">
        {[
          ...
          <Accordion open={open === key + 1} key={key} icon={<Icon id={1} open={open} />}>
            <AccordionHeader onClick={() => handleOpen(key + 1)}>{item.question}</AccordionHeader>
            <AccordionBody>
        ...
        <p className="text-lg font-medium text-primary underline underline-offset-4 decoration-primary-400 leading-relaxed max-w-3xl mx-auto mt-5">
          Please note that this is a fictional example, and the details should be customized based on the specific information and services provided by Prime Ready Mix.
        </p>
      </div>
...
const Services = () => {
  return (
    <main>
      <section className="py-10 relative">
        <div className="container ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 py-10 md:py-14">
            <div className="">
              <h2 className="font-semibold text-center md:text-left mb-1">
              ...
              <p className="flex-grow text-dark-300 text-center md:text-left">
                If you're in need of reliable concrete delivery services in Toronto, look no further. Our company is dedicated to providing top-notch concrete solutions tailored to your specific needs. With a fleet of modern and well-maintained vehicles, we ensure prompt and efficient delivery to your construction site. Our team of skilled professionals is committed to delivering high-quality concrete on time, every time. Whether you require a small batch for a DIY project or a large-scale commercial delivery, we have the expertise and resources to meet your requirements. Trust us for hassle-free and dependable concrete delivery services in Toronto, and let us contribute to the success of your construction endeavours.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-dark-300 mb-2">
              If you find yourself frustrated with your outdated home, it might be time to embark on a transformative journey of renovation and rejuvenation. A home is more than just four walls; it's a reflection of your personality, a sanctuary from the world, and a place where memories are made. Outdated spaces can stifle creativity and hinder the sense of comfort we all seek.
            </p>
            <p className="text-dark-300 mb-2">
              Embracing change, whether it's through a fresh coat of paint, modernizing fixtures, or a complete overhaul, can breathe new life into your living environment. So, take that first step towards a more vibrant and inviting space; your revitalized home will not only elevate your daily experience but also inspire you to create new chapters of joy and fulfillment within its walls. </p>
          </div>
          <img
      ...
      <section className="py-10">
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="h-1 w-40 bg-primary my-5" />
            <p className="text-dark-300 mb-2">
              Welcome to our dedicated team, committed to resolving all your concrete woes. Whether it's a cracked driveway, an uneven patio, or a complete structural overhaul, we're here to tackle it head-on. With years of expertise and a passion for precision, we pride ourselves on delivering durable, long-lasting solutions. Our skilled professionals employ the latest techniques and top-quality materials to ensure your concrete project stands the test of time. Say goodbye to unsightly imperfections and hello to a flawless finish. Trust us to transform your concrete challenges into solid, reliable results. Let's build a foundation with our concrete delivery services, which you can rely on.
            </p>
          </div>
      ...
      <section className="py-10">
        <div className="container">
          <h2 className="text-center text-dark-400 mb-5">Why Choose Us for <span className="text-primary">Ready Mix Concrete Toronto</span>?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-3 gap-y-4 mb-3">
            {[
              ...
              <p key={item?.id}>
                <span className="font-bold inline-block me-1">{String(item.id).padStart(2, 0)} .</span>
                <span className="text-primary font-semibold inline-block me-2 underline underline-offset-4 decoration-slice decoration-primary">{item.title} : </span>
                <span className="text-dark-400">{item.desc}</span>
              </p>
            ))}
          </div>
          <p className="p-2 border-l-4 border-primary bg-primary-50 font-medium">
            In summary, choosing us for your ready mix concrete delivery means opting for quality, expertise, timely service, customization, cost-effectiveness, sustainability, safety, technical support, and a strong commitment to customer satisfaction. We're not just a supplier; we're a partner in your construction success.
          </p>
        </div>
      </section>
      <section className="py-10">
        <div className="container">
          <h2 className="text-center text-dark-400 mb-5">How <span className="text-primary">We Solve</span> Your Construction Problems</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-3 gap-y-4 mb-3">
            {[
              {
                "id": 1,
          ...
          <p className="p-2 border-l-4 border-primary bg-primary-50 font-medium">
            By following this comprehensive approach, we tackle construction problems with precision, expertise, and a commitment to excellence. Your project's success is our priority, and we're dedicated to delivering results that exceed your expectations.
          </p>
        </div>
      </section>
      <section className="py-10">
        <div className="container">
          <div className="mb-5 text-left md:text-center">
            <h2 className=" text-dark-400  mb-2">Preparing a <span className="text-primary">Customized Plan</span> for Concrete Supply</h2>
            <p className="text-lg max-w-3xl mx-auto leading-relaxed font-medium text-dark-400">
              By following this customized concrete supply plan, you can ensure a smooth and efficient process from the initial assessment to the successful completion of your construction project.
            </p>
          </div>
            ...
            {[
              {
                ...
                "list": ["Define the scope of the project, including location, size, and type of construction.", "Identify specific requirements for concrete, such as strength, mix design, and special additives."]
              },
              {
                "id": 2,
                "title": "Site Assessment",
                "list": ["Conduct a thorough site visit to assess access points, potential obstacles, and any special requirements for concrete delivery.", "Determine if any special equipment (e.g., pumps, conveyors) will be needed."]
              },
              {
                "id": 3,
                "title": "Concrete Mix Design",
                "list": ["Collaborate with a qualified concrete supplier to develop a mix design tailored to project specifications and local conditions.", "Consider factors like required strength, durability, workability, and environmental considerations."]
              },
              {
                "id": 4,
                "title": "Quantity Estimation",
                "list": ["Calculate the total volume of concrete required based on project drawings and specifications.", "Factor in any potential overages or adjustments for waste."]
              },
              {
                "id": 5,
                "title": "Delivery Schedule",
                "list": ["Create a detailed schedule outlining the timing and quantities of concrete deliveries.", "Consider factors like curing times, weather conditions, and site constraints."]
              },
              {
                "id": 6,
                "title": "Supplier Selection",
                "list": ["Evaluate potential concrete suppliers based on their track record, quality control measures, and proximity to the project site.", "Obtain multiple quotes for comparison."]
              },
              {
                "id": 7,
                "title": "Transportation Logistics",
                "list": ["Determine the most efficient transportation methods for delivering concrete to the site.", "Plan routes and consider any legal or logistical restrictions."]
              },
              {
                "id": 8,
                "title": "Quality Control Measures",
                "list": ["Establish procedures for testing and verifying the quality of concrete batches.", "Define acceptance criteria and inspection points."]
              },
              {
                "id": 9,
                "title": "Special Considerations",
                "list": ["Identify any special requirements, such as coloured concrete, rapid-setting mixes, or specialized finishing techniques.", "Ensure that suppliers can meet these specific needs."]
              },
              {
                "id": 10,
                "title": "Contingency Planning",
                "list": ["Develop contingency plans for unforeseen circumstances, such as unexpected delays, changes in project scope, or adverse weather conditions."]
              },
              {
                "id": 11,
                "title": "Communication and Coordination",
                "list": ["Establish clear lines of communication between the project team, concrete supplier, and any other stakeholders involved.", "Regularly update all parties on progress and any changes to the plan."]
              },
              {
                "id": 12,
                "title": "Environmental and Regulatory Compliance",
                "list": ["Ensure that all concrete production and delivery processes comply with local environmental regulations.", "Consider sustainable sourcing options and waste management practices."]
              },
              {
                "id": 13,
                "title": "Cost Analysis and Budgeting",
                "list": ["Create a detailed cost analysis that includes concrete supply, transportation, and any additional expenses related to the concrete supply plan.", "Allocate a budget and monitor expenses throughout the project."]
              },
              {
                "id": 14,
                "title": "Documentation and Reporting",
                "list": ["Maintain thorough records of all concrete-related activities, including delivery receipts, quality test results, and any incidents or deviations from the plan.", "Generate regular reports to track progress and ensure compliance with the plan."]
              },
              {
                "id": 15,
                "title": "Post-Project Evaluation",
                "list": ["Conduct a comprehensive evaluation after project completion to assess the effectiveness of the concrete supply plan."]
              }
            ].map(item => (
              <figure key={item?.id} className="px-3 py-4 bg-primary-50 border-2 border-primary-300 rounded-sm">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-black tracking-widest">{String(item.id).padStart(2, 0)}</h1>
                <h6 className="text-lg md:text-xl lg:text-2xl text-primary font-semibold mb-2 ">{item.title}</h6>
                {item.list.map(e => (
                  <p className="mb-3 flex gap-2 items-start"><span className="inline-block min-h-[8px] min-w-[8px] mt-2 rounded-full bg-primary" /> <span>{e}</span></p>
                ))}
              </figure>
            ))}
          </div>
      ...
      <section className="py-10 relative">
        <div className="container grid grid-cols-1 md:grid-cols-2">
          <div className="">
            <div className="mb-5">
              <h2 className=" text-dark-400  mb-2">Expert <span className="text-primary">Design and Material</span> Selection for Premix Concrete</h2>
              <p className="text-lg leading-relaxed font-medium text-dark-400">
                Creating high-quality premix concrete involves careful consideration of design and material selection. This process requires expertise to ensure the final product meets the desired strength, durability, and workability standards. Below are essential steps for achieving excellence in premix concrete delivery.
              </p>
            </div>
            {[
              {
              ...
              <figure key={item?.id} className="px-3 py-4 bg-primary/5 border-l-4 border-primary rounded-sm mb-3">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-black tracking-widest">{String(item.id).padStart(2, 0)}</h1>
                <h6 className="text-lg md:text-xl lg:text-2xl text-primary font-semibold mb-2 ">{item.title}</h6>
                {item.list.map(e => (
                  <p className="pl-4 text-[16px] mb-3 flex gap-2 items-start"><span className="inline-block min-h-[8px] min-w-[8px] mt-2 rounded-full bg-primary" /> <span>{e}</span></p>
                ))}
              </figure>
            ))}
            <br />
            <p className="leading-relaxed text-lg font-medium text-dark-400">
              By following these expert steps in design and material selection, you can produce high-quality premix concrete that meets or exceeds the required standards for strength, durability, and workability. Remember that attention to detail and a commitment to excellence are essential to achieving consistent and reliable results.
            </p>
          </div>
          <img src="https://img1.wsimg.com/isteam/ip/0b1f7c84-a64a-49ce-ae1c-c51b120d8ea2/P85-side-e1663291233852.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1352,h:500,cg:true" alt="" className="sticky top-32 w-full" />
        </div>
      </section>
      ...
      <section className="py-10 relative">
        <div className="container grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 className="mb-5">The Benefits of Choosing Us for Concrete Services in Toronto</h2>
            ...
            {[
              ...
              <p key={key} className="text-dark-400 mb-3">
                <span className="font-bold text-dark underline underline-offset-4 decoration-dark">{String(item?.id).padStart(2, 0)} . </span><span className="underline underline-offset-4 decoration-primary text-primary font-medium"> {item?.title}</span> <span> : {item?.desc}</span>
              </p>
            ))}
            <p className="text-lg border-l-4 border-primary bg-primary-50 p-3 font-medium">
              Choosing our concrete services in Toronto means choosing a team dedicated to excellence, quality, and customer satisfaction. Contact us today to discuss your concrete project and experience the difference firsthand.
            </p>
          </div>
          <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="">
              <div className="mb-3">
                ...
                <p className="text-dark-300 mb-2">
                  Are you prepared to embark on a remarkable journey of home transformation? Imagine a space that reflects your unique personality and style, a haven that truly feels like "you." Whether you're dreaming of a cozy cottage retreat, a sleek modern oasis, or a vibrant bohemian escape, the possibilities are endless. With the right vision, creativity, and a touch of inspiration, your home can become a canvas for your imagination. Let's turn your aspirations into reality, one room at a time, and embark on this exciting adventure together. Get ready to witness the incredible metamorphosis of your living space as we bring your dreams to life. Your home transformation journey awaits, and the results will be nothing short of magical.
                </p>
              </div>
              <div className="mb-3">
                <h4 className="font-bold">
                ...
                <div className="h-1 w-40 bg-primary my-1" />
                <p className="text-dark-300 mb-2">
                  Nestled at the edge of a tranquil woodland, your dream home awaits, a haven where every sunrise paints a masterpiece on the horizon and every sunset serenades the day to rest. This idyllic sanctuary is a symphony of modern elegance and natural beauty, seamlessly woven together. The architecture marries the timeless charm of rustic stone with sleek lines of contemporary design, creating a residence that feels both grounded and ethereal. As you step inside, sunlight dances through large picture windows, illuminating a space that exudes warmth and welcomes you with open arms. Each room tells a story, a tale spun from the finest materials and the most thoughtful craftsmanship. The kitchen, a culinary haven, boasts granite countertops and state-of-the-art appliances, where the aroma of freshly baked bread mingles with the fragrance of herbs from your garden. The bedrooms are sanctuaries of repose, cocooned in soft linens and bathed in gentle moonlight. Step outside to your private oasis, where a garden of blooms and a chorus of songbirds await. The scent of blooming roses mingles with the earthy aroma of a well-loved path. Your dream home is not just a dwelling but a sanctuary, a canvas waiting for your personal touch to transform it into a masterpiece of memories. We are ready to make your dream home with our concrete delivery service.
              ...
              <div className="mb-3">
                ...
                <div className="h-1 w-40 bg-primary my-1" />
                <p className="text-dark-300 mb-2">
                  Let's get started with ready mixed concrete services! Ready mixed concrete is a versatile and essential building material that has revolutionized the construction industry. Whether you're embarking on a small DIY project or managing a large-scale construction site, Prime Ready Mix offers convenience, consistency, and quality concrete delivery. This concrete is precisely mixed at a batching plant to meet your project's specific requirements, ensuring the right proportions of cement, aggregates, and water. It arrives at your site ready to pour, saving you time and effort compared to on-site mixing. With its reliability and efficiency, ready mixed concrete is the foundation for durable and structurally sound buildings. So, let's dive into the world of ready mixed concrete and discover how it can streamline your construction endeavours and deliver outstanding results!
                </p>
              </div>
              <div className="mb-3">
                <h4 className="font-bold">
                ...
                <div className="h-1 w-40 bg-primary my-1" />
                <p className="text-dark-300 mb-2">
                  If you're on the lookout for an affordable ready mix concrete company in Toronto, your search ends here. Our company is committed to providing top-notch, quality concrete delivery solutions at prices that won't break the bank. With years of experience in the industry, we understand the importance of delivering reliable and cost-effective ready mix concrete for your construction projects. Whether it's a small residential endeavour or a large-scale commercial venture, we have the expertise and resources to meet your concrete needs efficiently. Rest assured, our team prioritizes both affordability and quality, ensuring you get the best value for your investment. Contact us today to experience seamless service and premium ready mix concrete tailored to your budget. Your project's success is our priority!
                </p>
              </div>
              <div className="mb-3">
                <h4 className="font-bold">
                ...
                <div className="h-1 w-40 bg-primary my-1" />
                <p className="text-dark-300 mb-2">
                  As your dedicated concrete ready mix supplier, Prime Ready Mix takes pride in delivering top-notch quality and unmatched service. Our team is committed to providing you with a seamless experience from order to delivery. Whether you're embarking on a large-scale construction project or a smaller DIY endeavour, we understand the importance of reliable and consistent concrete delivery. With years of expertise in the industry, we offer a diverse range of concrete mixes tailored to meet your specific requirements. From high-strength foundations to decorative finishes, we've got you covered. Trust in our expertise, and let us be your partner in building a solid foundation for success.
                </p>
              </div>
              <div className="mb-3">
                <h4 className="font-bold">
                  Ready to experience the ultimate in premixed concrete delivery services?
                </h4>
                <div className="h-1 w-40 bg-primary my-1" />
                <p className="text-dark-300 mb-2">
                  Introducing a revolution in construction efficiency: our premier premixed concrete delivery services are set to redefine the industry standard. We understand that time is of the essence on any job site, which is why we've meticulously crafted a service that marries precision and convenience. With our state-of-the-art mixing technology and a fleet of specialized delivery vehicles, we guarantee a seamless experience from order to pour. Our expert team ensures that every batch of concrete meets the highest quality standards, tailored to your project's unique specifications. Say goodbye to delays and wastage; with us, you'll have the perfect mix, precisely when and where you need it. Elevate your construction game with the ultimate in Prime Ready Mix services. Efficiency, reliability, and excellence—it's not just our promise; it's our foundation.
                </p>
              </div>
            </div>
            <img src="https://img1.wsimg.com/isteam/ip/0b1f7c84-a64a-49ce-ae1c-c51b120d8ea2/P85-side-e1663291233852.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1352,h:500,cg:true" alt="" className="w-full sticky top-32 " />
          </div>
        </div>
      </section>
