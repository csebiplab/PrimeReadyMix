            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[20px] md:gap-[30px] 5xl:gap-[37px]'>
                ...
                <div className='md:col-span-1'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-dark-300 font-normal leading-[35px] text-center md:text-left mt-[10px]'>Prime Ready Mix's concrete services offer a seamless solution for all your concrete needs and <Link href="https://www.readymixnearme.ca/concrete-delivery" rel="nofollow" target="_blank">concrete delivery</Link> services in GTA. With a fleet of state-of-the-art mixing trucks, we ensure that you receive the highest-quality concrete precisely when and where you need it. Whether it's a small residential project or a large commercial undertaking, we design our Toronto-ready mix services to save you time, labour, and the costs associated with on-site mixing. We take pride in our commitment to delivering consistent, durable, and reliable <Link href="https://www.readymixnearme.ca/concrete-delivery" rel="nofollow" target="_blank">concrete mixes</Link> tailored to meet the unique specifications of each project.
